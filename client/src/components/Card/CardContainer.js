...
export default class CardContainer extends React.Component {
  ...
  savedLocationsTwo(event) {
    ...
    axios
      .post("/user/renderSavedLocations")
      .then((response) => {
        ...
        >
          <Card.Body>
            ...
            <form onSubmit={this.handleSubmit}>
              ...
              <button
                id="searchButton"
                className="col-6 mx-auto btn-md btn btn-info btn-block"
                type="submit"
              >
                Search
              </button>
              ...
              <button
                id="savedButton"
                onClick={this.savedLocationsTwo}
                className="col-8 mx-auto btn-md btn btn-success btn-block"
                type="submit"
              >
                Saved Locations
              </button>
